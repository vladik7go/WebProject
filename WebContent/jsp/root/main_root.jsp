...
<form name="choose_action_form" method="POST" action="controller">
 ...
 <table  border="3">
<th> # </th><th> <fmt:message key="login.label.role"/> </th><th><fmt:message key="login.label.firstname"/> </th><th> <fmt:message key="login.label.secondname"/> </th><th> <fmt:message key="login.label.login"/> </th><th colspan="3"> <fmt:message key="login.label.command"/> </th>
